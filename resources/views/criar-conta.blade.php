@vite(['resources/css/app.css','resources/js/app.js'])
  ...
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Crie sua conta no melhor sistema já desenvolvidos pelos alunos de GTI. Acesse o conteúdo e faça parte dessa história</p>
      <form action="#" class="space-y-8">
          ...
          <div>
              <label for="senha" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sua Senha</label>
